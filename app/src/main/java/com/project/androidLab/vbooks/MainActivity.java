...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Book, BooksViewHolder> FBRA = new FirebaseRecyclerAdapter<Book, BooksViewHolder>(
                Book.class,
                R.layout.card_items,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Toast.makeText(this, "That part does not work yet.. Sorry!!!", Toast.LENGTH_SHORT).show();
        }
